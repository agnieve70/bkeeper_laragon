...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <?php
        if (isset($_GET['code'])) {
            $sql10 = "UPDATE notification SET `code`='" . "' WHERE `code` = '" . $_GET['code'] . "'";
            $conn->query($sql10);
        }
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    if (isset($_POST['add_comment'])) {
                        echo "payts";
                        $sql13 = "INSERT INTO comments (comment, user_id, document_id, date)
                        VALUES ('" . $_POST['comment'] . "', '" . $_SESSION['user_id'] . "', '" . $_SESSION['id'] . "', '" . $currentDate->format('Y-m-d H:i:s') . "')";

                        if (mysqli_query($conn, $sql13)) {

                            $sql4 = "SELECT * from bkeepers WHERE client_id = " . $_SESSION['user_id'];
                            ...
                            if (mysqli_num_rows($result4) > 0) {
                                ...
                                VALUES ('Client Commented on a Document', 
