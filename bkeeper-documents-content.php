                ...
                <div class="col-md-5">
                    ...
                    if (isset($_POST['add_comment'])) {
                        ...
                        if (mysqli_query($conn, $sql3)) {
                            ...
                            $sql5 = "SELECT * from bkeeps WHERE id = " . $_SESSION['id'];
                            ...
                            if (mysqli_num_rows($result5) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result5)) {
                                    ...
                                    $sql7 = "INSERT INTO notification (`title`, `link`, `user_id`, `date`, `code`)
                                                        VALUES ('Bkeeper has a comment',
                                                                'http://localhost/bkeeper_laragon/admin-documents-content.php?id=" . $_SESSION['id'] . "',
                                                                '" . $row['client_id'] . "',
                                                                '" . date("Y-m-d h:i:sa") . "', '" . $rand . "')";

                                    mysqli_query($conn, $sql7);

                                    $sql6 = "SELECT * from bkeepers WHERE client_id =" . $row['client_id'];
                                ...
                                VALUES ('Bkeeper Commented on a Document', 
                                        'http://localhost/bkeeper_laragon/bkeeper-documents-content.php?id=" . $_SESSION['id'] ."',
                                        '" . $row2['bkeeper_id'] . "',
                                        '" . date("Y-m-d h:i:sa") . "', '".$rand."')";
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <div class="form-group">
                            <textarea class="form-control" name="comment" id="" rows="5"
                                      placeholder="Give Feedback or Comment . . ."></textarea>
                        </div>
