            ...
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end px-2" aria-labelledby="navbarDropdown">
                        ...
                        ?>
                        <center><a  href="http://localhost/bkeeper_laragon/admin-notification.php" class="text-center text-decoration-none">View All</a></center>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <span class="text-center mx-3 text-primary"><b>Hello Client!</b></span>
