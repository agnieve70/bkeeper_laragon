...
<main id="main">
                        ...
                        <div class="row">
                            <div id="first_set" class="row">
                                ...
                                <div class="text-center">
                                    <button type="button" style="background: #47b2e4;
                                        border: 0;
                                        padding: 12px 34px;
                                        color: #fff;
                                        transition: 0.4s;
                                        border-radius: 50px;" onclick="myFunction()">Next
                                    </button>
                                </div>
                            </div>
                            <div id="second_set" class="row" hidden>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="button" style="background: #889499;
                                        border: 0;
                                        padding: 12px 34px;
                                        color: #fff;
                                        transition: 0.4s;
                                        border-radius: 50px;" onclick="backPage()">Back
                                    </button>
    ...
    <script>
        function myFunction(){
            const first = document.getElementById('first_set');
            const second = document.getElementById('second_set');
            second.hidden=false;
            first.hidden=true;
        }
